pipeline {
    ...
    stages {
        ...
        steps {
            sh "sudo docker login -u 'grjcjrg5acih/oracleidentitycloudservice/marcio.zampiron@datacentrics.com.br' -p 'fnLej;{ehqnEhEKzHv7Q' gru.ocir.io"
            sh "sudo docker tag customapp:1 gru.ocir.io/grjcjrg5acih/customapp:custom"
            sh 'sudo docker push gru.ocir.io/grjcjrg5acih/customapp:custom'
